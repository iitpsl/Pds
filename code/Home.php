...
<div class="page-content-wrap"
	...
	<img src="img\Infographic-BG-removed (1) (1).png" alt="Infographic-BG-removed (1) (1).png" style="width: 100%; margin-left: 10px; opacity: 0.5;">
	<h1 style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1;">IMAGE</h1>
</div> -->


					<!-- <h1 style="font-weight: bold; text-align: center;">PDS Supply Chain of Punjab</h1> -->
					...
					<div class="panel-body">
						...
						<form action="" method="POST" class="form-horizontal" enctype="multipart/form-data" id="upload_button">
								...
								<div class="row">
									<div class="col-md-6">
										<div
											...
											<i class="fa fa-info-circle" aria-hidden="true"></i> Template</div>
										...
										<!-- <div class="form-group">
											...
											<div class="col-md-9">
												...
												<span class="help-block" style="font-weight: bold; color: black;"><b>Click to choose file</b></span>
							...
							<!-- <div class="panel-footer"> -->
								<!-- <input type="button" class="btn btn-primary pull-right" onclick="uploadFile()" value="Upload File" />
								<input style="margin-right:10px" type="button" class="btn btn-warning pull-right" onclick="downloadFile()" value="Download Template" /> -->
								<input style="margin-right: 352px; font-size: 18px; padding: 10px 16px;" type="button" class="btn btn-success pull-right" onclick="fetchFromDb()" value="Fetch Data from Database" />
				...
				<div class="col-md-3" id="sidebar" style="display:none; border-radius: 20px;">
					<div
						style="border: 2px solid #DC8686; padding: 15px; background-color: #DC8686; color: white; border-radius: 20px; margin-top:230px; margin-bottom: 10px;">
						<div class="card">
							<div class="row">
    ...
    <!-- <button class="button download_button_class" onclick="downloadFile('xlsx')" style="margin-right: 10px;">
        <span class="button__text button__text--download">Download XLSX</span>
    </button>
    <button class="button download_button_class" onclick="downloadFile('pdf')">
        <span class="button__text button__text--download">Download PDF</span>
    </button> -->
</div>
	...
	if (checkbox.checked) {
		...
		fetch('http://localhost:5000/getGraphData', {
			...
			.then(data => {
				...
				districtdata = data.District_Name_1;
