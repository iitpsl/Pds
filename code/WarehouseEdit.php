                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/WarehouseEdit.php" method="POST" target="_blank" class="form-horizontal" enctype = "multipart/form-data">
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
												   <span class="input-group-addon"><span class="fa fa-arrow-down"></span></span>
                                                    <select class="form-control select" id="district" name="district">
                                                    </select>
													</div>
